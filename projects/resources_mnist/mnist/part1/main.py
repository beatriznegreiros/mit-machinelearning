...
#     print('softmax test_error_mod3=', compute_test_error_mod3(test_x, np.mod(test_y, 3), theta, temp_parameter))
#
#     return test_error
#
#
...
# theta, cost_function_history = softmax_regression(train_pca, train_y, temp_parameter=1.0, alpha=0.3, lambda_factor=1.0e-4,
#                                                       k=10, num_iterations=150)
# test_error = compute_test_error(test_pca, test_y, theta, temp_parameter=1.0)
# print(test_error)
#
...
theta, cost_function_history = softmax_regression(train_cube, train_y, temp_parameter=1.0, alpha=0.3, lambda_factor=1.0e-4,
                                                      k=10, num_iterations=150)
test_error = compute_test_error(test_cube, test_y, theta, temp_parameter=1.0)
print('Cubic transformation on pca-transformed features: ', test_error)